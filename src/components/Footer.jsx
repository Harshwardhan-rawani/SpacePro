      ...
      <div className='bg-[#1e2565] p-4 flex xl:flex-row flex-col xl:justify-around xl:space-y-0 space-y-7'>
        <div>
          ...
          <p className='mt-2 text-white'>
            Get exclusive <span className='font-bold'>best updates</span> straight to your inbox
          </p>
          <div className='mt-3'>
        ...
        <div>
          <h1 className='text-white font-bold xl:text-xl text-lg'>Contact us</h1>
          <div className='text-white mt-2'>
            <div className='text-white flex'>
              <FaLocationDot className='text-white h-10 w-5' />
              <p className='text-white ml-2 mt-2'>Dhanbad, Jharkhand</p>
            </div>
            <div className='text-white flex'>
              <MdOutlineMail className='text-white h-10 w-5' />
              <p className='text-white ml-2 mt-2'>harsh@gmail.com</p>
            </div>
            <div className='text-white flex'>
              <FaPhoneAlt className='text-white h-10 w-5' />

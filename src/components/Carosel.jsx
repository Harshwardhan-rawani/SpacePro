...
>
  ...
  <div className="carousel-inner xl:h-[100vh] relative">
  ...
  <div className='bg-[#3b3b3b65] absolute bottom-0 p-4 w-screen space-y-2' data-aos="fade-right" data-aos-delay="0">
    ...
    <div className="text-center text-white italic">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita, laudantium necessitatibus. Quisquam impedit iure iusto.</div>

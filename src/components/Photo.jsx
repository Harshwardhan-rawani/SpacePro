  ...
  return (
   ...
   <div className='px-10'>
    ...
    <div className='flex lg:flex-row flex-col lg:justify-between lg:space-x-5  w-full'>
        ...
        <div className='lg:w-1/3 w-full my-6 shadow-lg rounded-md px-4 py-2 hover:bg-gray-900 border-b-2 border-r-2' data-aos="zoom-in" data-aos-delay="50">
        ...
        <div className='lg:w-1/3 w-full my-6 shadow-lg rounded-md px-4 py-2 hover:bg-gray-900 border-b-2 border-r-2' data-aos="zoom-in" data-aos-delay="100">
